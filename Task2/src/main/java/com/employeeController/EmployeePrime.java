...
private boolean editDisabled = false;
	...
	private LazyDataModel<EmployeeModel> lazyemployees;
	...
	public LazyDataModel<EmployeeModel> getLazyemployees() {
	return lazyemployees;
}

public void setLazyemployees(LazyDataModel<EmployeeModel> lazyemployees) {
	this.lazyemployees = lazyemployees;
}
	...
	@PostConstruct
	public void init() {
		lazyemployees= new EmployeeLazy(employeeServiceImpl);
//		employees=employeeServiceImpl.findAll();
	...
	public void onCellEdit(CellEditEvent event) {
        ...
        EmployeeModel employeeEdit = (EmployeeModel) dataTable.getRowData();
        
        employeeServiceImpl.editEmployee(employeeEdit);
